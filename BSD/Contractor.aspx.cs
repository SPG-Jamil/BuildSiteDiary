...
namespace BSD
{
    ...
    {
        public string screen = "Contractor";
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                ContractorStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectContractor_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectContractor.Items.Count > 0)
                {
                    SelectContractor.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
