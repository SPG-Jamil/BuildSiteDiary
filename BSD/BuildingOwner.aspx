<%@ Page Title="" Language="C#" MasterPageFile="~/BSDMaster.Master" AutoEventWireup="true" CodeBehind="BuildingOwner.aspx.cs" Inherits="BSD.BuildingOwner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="app-container-without-bg p-t-15">
        ...
        <div class="app-body">
            <h1 class="app-page-heading"><%= Get("bldo")%></h1>
            ...
            <div class="tab-content">
                    ...
                    <div class="app-tab-body">
                        ...
                        <div class="row">
                            <div class="col-md-10 p-l-0">
                                <div class="col-md-3">
                                    <label class="app-data-label"><%= Get("BldoStatus")%></label>
                                    <asp:TextBox class="form-control app-data-field" ID="BuildingOwnerStatusBox" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-md-5">
                ...
                <div id="contact" class="tab-pane fade">
                    <div class="app-tab-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("SlctBldgOnr")%></label>
                                <asp:DropDownList ID="SelectBuildingOwner" class="form-control app-data-field" runat="server" OnSelectedIndexChanged="SelectBuildingOwner_OnSelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("BsnsName")%></label>
