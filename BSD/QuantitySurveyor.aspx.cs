...
namespace BSD
{
    public partial class QuantitySurveyor : BasePage
    {
        public string screen = "QuantitySurveyor";
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectQuantitySurveyor.Items.Count > 0)
                {
                    SelectQuantitySurveyor.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                QuantitySurveyorStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectQuantitySurveyor_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
