...
namespace BSD
{
    public partial class BuildingInspector : BasePage
    {
        public string screen = "BuildingInspector";
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectBuildingInspector.Items.Count > 0)
                {
                    SelectBuildingInspector.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                BuildingInspectorStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectBuildingInspector_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
