...
namespace BSD
{
    public partial class Developer : BasePage
    {
        public string screen = "Developer";
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                DeveloperStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectDeveloper_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectDeveloper.Items.Count > 0)
                {
                    SelectDeveloper.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
