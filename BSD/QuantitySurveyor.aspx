<%@ Page Title="" Language="C#" MasterPageFile="~/BSDMaster.Master" AutoEventWireup="true" CodeBehind="QuantitySurveyor.aspx.cs" Inherits="BSD.QuantitySurveyor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="app-container-without-bg p-t-15">
        ...
        <div class="app-body">
            <h1 class="app-page-heading"><%= Get("qtysury")%></h1>
            ...
            <div class="tab-content">
                    ...
                    <div class="app-tab-body">
                        ...
                        <div class="row">
                            <div class="col-md-10 p-l-0">
                                <div class="col-md-3">
                                    <label class="app-data-label"><%= Get("qtysuryStats")%></label>
                                    <asp:TextBox class="form-control app-data-field" ID="QuantitySurveyorStatusBox" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-md-5">
                ...
                <div id="contact" class="tab-pane fade">
                    <div class="app-tab-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("SltQtySurveyor")%></label>
                                <asp:DropDownList ID="SelectQuantitySurveyor" class="form-control app-data-field" runat="server" OnSelectedIndexChanged="SelectQuantitySurveyor_OnSelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("BsnsName")%></label>
