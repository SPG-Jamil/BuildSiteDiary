...
namespace BSD
{
    public partial class PrivateCertifier : BasePage
    {
        public string screen = "PrivateCertifier";
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectPrivateCertifier.Items.Count > 0)
                {
                    SelectPrivateCertifier.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                PrivateCertifierStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectPrivateCertifier_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
