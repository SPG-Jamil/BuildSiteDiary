<%@ Page Title="" Language="C#" MasterPageFile="~/BSDMaster.Master" AutoEventWireup="true" CodeBehind="BuildingInspector.aspx.cs" Inherits="BSD.BuildingInspector" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="app-container-without-bg p-t-15">
        ...
        <div class="app-body">
            <h1 class="app-page-heading"><%= Get("bldinsp")%></h1>
            ...
            <div class="tab-content">
                    ...
                    <div class="app-tab-body">
                        ...
                        <div class="row">
                            <div class="col-md-10 p-l-0">
                                <div class="col-md-3">
                                    <label class="app-data-label"><%= Get("BldinspStats")%></label>
                                    <asp:TextBox class="form-control app-data-field" ID="BuildingInspectorStatusBox" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-md-5">
                ...
                <div id="contact" class="tab-pane fade">
                    <div class="app-tab-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("SelectBuildingInspector")%></label>
                                <asp:DropDownList ID="SelectBuildingInspector" class="form-control app-data-field" runat="server" OnSelectedIndexChanged="SelectBuildingInspector_OnSelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("BsnsName")%></label>
