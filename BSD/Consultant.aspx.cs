...
namespace BSD
{
    public partial class Consultant : BasePage
    {
        public string screen = "Consultant";
        ...
        protected void SelectConsultant_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectConsultant.Items.Count > 0)
                {
                    SelectConsultant.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
