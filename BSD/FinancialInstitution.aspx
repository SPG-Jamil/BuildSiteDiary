<%@ Page Title="" Language="C#" MasterPageFile="~/BSDMaster.Master" AutoEventWireup="true" CodeBehind="FinancialInstitution.aspx.cs" Inherits="BSD.FinancialInstitution"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="app-container-without-bg p-t-15">
        ...
        <div class="app-body">
            <h1 class="app-page-heading"><%= Get("fininst")%></h1>
            ...
            <div class="tab-content">
                    ...
                    <div class="app-tab-body">
                        ...
                        <div class="row">
                            <div class="col-md-10 p-l-0">
                                <div class="col-md-3">
                                    <label class="app-data-label"><%= Get("FininstStatus")%></label>
                                    <asp:TextBox class="form-control app-data-field" ID="FinancialInstitutionStatusBox" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-md-5">
                ...
                <div id="contact" class="tab-pane fade">
                    <div class="app-tab-body">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("SlctFncalInstttn")%></label>
                                <asp:DropDownList ID="SelectFinancialInstitution" class="form-control app-data-field" runat="server" OnSelectedIndexChanged="SelectFinancialInstitution_OnSelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                <label class="app-data-label"><%= Get("BsnsName")%></label>
                        ...
                        <div class="row m-t-20">
                            <div class="col-md-12">
                                <asp:GridView AutoGenerateColumns="false" CssClass="table table-hover app-gridview" ID="ContactsGrid" runat="server">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
