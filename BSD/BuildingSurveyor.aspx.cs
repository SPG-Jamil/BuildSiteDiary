...
namespace BSD
{
    public partial class BuildingSurveyor : BasePage
    {
        public string screen = "BuildingSurveyor";
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectBuildingSurveyor.Items.Count > 0)
                {
                    SelectBuildingSurveyor.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                BuildingSurveyorStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectBuildingSurveyor_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
