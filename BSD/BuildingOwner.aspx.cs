...
namespace BSD
{
    public partial class BuildingOwner : BasePage
    {
        public string screen = "BuildingOwner";
        ...
        protected void ClearButton_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SelectBuildingOwner.Items.Count > 0)
                {
                    SelectBuildingOwner.SelectedIndex = 0;
                }
            }
            catch (Exception exception)
            {
        ...
        protected void ButtonClear_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                BuildingOwnerStatusBox.Text = string.Empty;
            }
            catch (Exception exception)
            {
                ErrorDescription.Text = exception.Message;
        ...
        protected void SelectBuildingOwner_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
            }
